...
static const unsigned int gappxi    = 15; //only affects vantile
static const unsigned int gappxo    = 10; //only affects vantile
...
{ MODKEY|ShiftMask|ControlMask,XK_q,		quit,           {0} },
	...
	{ MODKEY,              XK_bracketleft,  setlayout,          {.v = &layouts[5] } },
